...
def data_analysis(dispId):
    ...
    outputFilename = formatBdd2RData(r, dispId, r_lastCycle, dispName)
    
    outputFilename = ''.join(outputFilename)
    return outputFilename

def formatBdd2RData(r, dispId, lastCycle, dispName):
    ...
    outputFilename = BDD2Rdata.bdd2Rdata(dispId, lastCycle, dispName, r_placettes, r_arbres, r_bmss, r_reges, r_transects, r_reperes, r_cycles)
    return outputFilename