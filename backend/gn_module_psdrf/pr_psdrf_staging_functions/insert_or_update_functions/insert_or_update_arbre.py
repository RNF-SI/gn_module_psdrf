            ...
            for category in ['created', 'updated', 'deleted']:
                if category in arbres_data:
                    for arbre_data in arbres_data[category]:
                        id_arbre = None  # Initialize id_arbre to None or a safe default value
                        if category == 'created':
                            ...
                            created_arbres.append({"status": "created", "id": new_arbre.id_arbre, "new_id_arbre_orig": new_id_arbre_orig})
                            counts_arbre['created'] += 1
                            id_arbre = new_arbre.id_arbre  # Now id_arbre is safely assigned
                            ...
                            if existing_arbre:
                                ...
                                id_arbre = existing_arbre.id_arbre  # id_arbre is safely assigned
                            ...
                            if arbre_to_delete:
                                ...
                                id_arbre = arbre_data['id_arbre']  # Safely assume deletion ID matches input

                        if 'arbres_mesures' in arbre_data and id_arbre is not None:  # Check for None to avoid errors
